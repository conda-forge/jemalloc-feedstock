...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/jemalloc-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jemalloc-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add jemalloc jemalloc-local libjemalloc libjemalloc-local
# for installing globally
pixi global install jemalloc jemalloc-local libjemalloc libjemalloc-local
```
...
It is possible to list all of the versions of `jemalloc` available on your platform:
...
```
pixi search jemalloc --channel conda-forge
```
